...
namespace Microsoft.Azure.Management.DataMigration
{
    ...
    public static partial class ServicesOperationsExtensions
    {
            ...
            /// </param>
            public static ScenarioResult RunTask(this IServicesOperations operations, string groupName, string resourceName, NewServiceTask parameters, int? timeoutMs = default(int?))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ScenarioResult> RunTaskAsync(this IServicesOperations operations, string groupName, string resourceName, NewServiceTask parameters, int? timeoutMs = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
