...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class NonSqlDataMigrationTableResult
    {
        ...
        /// migration</param>
        public NonSqlDataMigrationTableResult(DataMigrationResultCode? resultCode = default(DataMigrationResultCode?), string sourceName = default(string), string targetName = default(string), long? sourceRowCount = default(long?), long? targetRowCount = default(long?), double? elapsedTimeInMiliseconds = default(double?), IList<DataMigrationError> errors = default(IList<DataMigrationError>))
        {
        ...
        public DataMigrationResultCode? ResultCode { get; private set; }
