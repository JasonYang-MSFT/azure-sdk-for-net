...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// <summary>
    /// Input for task that validates migration input for SQL to Cloud DB
    /// migrations
    /// </summary>
    public partial class ValidateMigrationInputSqlServerCloudDbTaskInput
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ValidateMigrationInputSqlServerCloudDbTaskInput class.
        /// </summary>
        public ValidateMigrationInputSqlServerCloudDbTaskInput()
        {
            CustomInit();
        }
        ...
        /// the encryption.
        /// </param>
        public ValidateMigrationInputSqlServerCloudDbTaskInput(SqlConnectionInfo targetConnectionInfo, IList<MigrateSqlServerSqlServerDatabaseInput> selectedDatabases, string backupShareUserName, string backupSharePassword = default(string))
        {
