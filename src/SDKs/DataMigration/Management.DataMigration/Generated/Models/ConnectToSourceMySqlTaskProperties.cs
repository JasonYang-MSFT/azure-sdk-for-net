...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ConnectToSourceMySqlTaskProperties : ProjectTaskProperties
    {
        ...
        /// submitted.</param>
        public ConnectToSourceMySqlTaskProperties(IList<ODataError> errors = default(IList<ODataError>), TaskState? state = default(TaskState?), ConnectToSourceMySqlTaskInput input = default(ConnectToSourceMySqlTaskInput), IList<ConnectToSourceNonSqlTaskOutput> output = default(IList<ConnectToSourceNonSqlTaskOutput>))
            : base(errors, state)
        {
            Input = input;
            Output = output;
