...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// migrations
    /// </summary>
    public partial class ValidateMigrationInputSqlServerSqlServerTaskOutput : TaskOutput
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ValidateMigrationInputSqlServerSqlServerTaskOutput class.
        /// </summary>
        public ValidateMigrationInputSqlServerSqlServerTaskOutput()
        {
            CustomInit();
        }
        ...
        public ValidateMigrationInputSqlServerSqlServerTaskOutput(string id = default(string), string name = default(string), IList<ReportableException> restoreDatabaseNameErrors = default(IList<ReportableException>), IList<ReportableException> backupAndRestoreFolderErrors = default(IList<ReportableException>), IDictionary<string, IList<ReportableException>> databaseFilesErrors = default(IDictionary<string, IList<ReportableException>>))
            : base(id)
        {
            Name = name;
