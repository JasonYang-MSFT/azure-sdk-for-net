...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// <summary>
    /// Input for the task that validates connection to SQL Server and target
    /// server requirements
    /// </summary>
    public partial class ConnectToTargetSqlServerTaskInput
    {
        /// <summary>
        /// Initializes a new instance of the ConnectToTargetSqlServerTaskInput
        /// class.
        /// </summary>
        public ConnectToTargetSqlServerTaskInput()
        {
            CustomInit();
        }
        ...
        public ConnectToTargetSqlServerTaskInput(SqlConnectionInfo targetConnectionInfo)
        {
