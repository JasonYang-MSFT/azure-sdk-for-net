...
namespace Microsoft.Azure.DataMigrationService.Models
{
    ...
    /// <summary>
    /// Scenario result for StartCloudDBMigrationScenario
    /// </summary>
    public partial class StartCloudDBMigrationScenarioResult : MigrationScenarioResult
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StartCloudDBMigrationScenarioResult class.
        /// </summary>
        public StartCloudDBMigrationScenarioResult()
        {
          CustomInit();
        }
        ...
        /// warnings.</param>
        public StartCloudDBMigrationScenarioResult(string id = default(string), string name = default(string), System.DateTimeOffset? startedOn = default(System.DateTimeOffset?), System.DateTimeOffset? endedOn = default(System.DateTimeOffset?), MigrationStatus? status = default(MigrationStatus?), string message = default(string), IDictionary<string, string> databases = default(IDictionary<string, string>), IList<ReportableException> exceptionsAndWarnings = default(IList<ReportableException>))
            : base(id)
        {
            Name = name;
            StartedOn = startedOn;
