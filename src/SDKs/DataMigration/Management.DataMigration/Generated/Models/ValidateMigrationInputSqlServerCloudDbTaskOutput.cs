...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// <summary>
    /// Output for task that validates migration input for SQL to Cloud DB
    /// migrations
    /// </summary>
    public partial class ValidateMigrationInputSqlServerCloudDbTaskOutput : TaskOutput
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ValidateMigrationInputSqlServerCloudDbTaskOutput class.
        /// </summary>
        public ValidateMigrationInputSqlServerCloudDbTaskOutput()
        {
            CustomInit();
        }
        ...
        public ValidateMigrationInputSqlServerCloudDbTaskOutput(string id = default(string), string name = default(string), IList<ReportableException> restoreDatabaseNameErrors = default(IList<ReportableException>), IList<ReportableException> backupFolderErrors = default(IList<ReportableException>), IList<ReportableException> backupShareCredentialsErrors = default(IList<ReportableException>))
            : base(id)
        {
            Name = name;
