...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// <summary>
    /// Output for the task that validates connection to Cloud DB
    /// </summary>
    public partial class ConnectToTargetCloudDbTaskOutput : TaskOutput
    {
        /// <summary>
        /// Initializes a new instance of the ConnectToTargetCloudDbTaskOutput
        /// class.
        /// </summary>
        public ConnectToTargetCloudDbTaskOutput()
        {
            CustomInit();
        }
        ...
        public ConnectToTargetCloudDbTaskOutput(string id = default(string), string targetServerVersion = default(string), string targetServerBrandVersion = default(string), IList<ReportableException> validationErrors = default(IList<ReportableException>))
            : base(id)
        {
