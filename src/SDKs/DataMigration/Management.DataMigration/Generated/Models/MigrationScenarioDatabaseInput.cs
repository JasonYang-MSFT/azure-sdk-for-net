...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// <summary>
    /// Database specific information for scenario inputs
    /// </summary>
    public partial class MigrationScenarioDatabaseInput
    {
        /// <summary>
        /// Initializes a new instance of the MigrationScenarioDatabaseInput
        /// class.
        /// </summary>
        public MigrationScenarioDatabaseInput()
        {
          CustomInit();
        }
        ...
        public MigrationScenarioDatabaseInput(string id = default(string), string name = default(string), string restoreDatabaseName = default(string), string backupAndRestoreFolder = default(string), IList<ScenarioDatabaseFileInput> databaseFiles = default(IList<ScenarioDatabaseFileInput>))
        {
            Id = id;
            Name = name;
        ...
        public IList<ScenarioDatabaseFileInput> DatabaseFiles { get; set; }
